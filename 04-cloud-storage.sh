...
gsutil mb gs://loony-oreilly-bucket-one
...
gsutil mb gs://loony-oreilly-bucket-two

gsutil ls


gsutil mb -c regional -l us-central1 gs://loony-oreilly-bucket-three

gcloud storage buckets create gs://loony-oreilly-bucket-four --location=us-central1 --default-storage-class=coldline --uniform-bucket-level-access
...
Select the loony-oreilly-bucket-one
...
Go to another bucket loony-oreilly-bucket-two
...
$ gsutil versioning get gs://loony-oreilly-bucket-one

$ gsutil versioning set on gs://loony-oreilly-bucket-one

Cannot set versioning on a bucket with a retention policy


$ gsutil versioning set on gs://loony-oreilly-bucket-two

$ gsutil versioning get gs://loony-oreilly-bucket-two


$ gsutil ls -L gs://loony-oreilly-bucket-two/Boomer.jpeg
...
$ gsutil ls -L gs://loony-oreilly-bucket-two/Boomer.jpg
...
Go to the web console for the bucket gs://loony-oreilly-bucket-two
...
=> Open the "loony-oreilly-bucket-two" bucket

=> Click on "Version history" and see the versions

=> Go back to the bucket "loony-oreilly-bucket-two"
...
=> Go back to the bucket "loony-oreilly-bucket-two" -> "Protection" -> "Object versioning" 
(Turn on)
...
gsutil signurl -d 10m key.json gs://loony-oreilly-bucket-two/cat.jpeg
